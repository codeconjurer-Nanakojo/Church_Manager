...
$stmt = $conn->prepare("SELECT full_name, email, phone, username, location FROM members ORDER BY full_name ASC");  
if (!$stmt->execute()) {  
...
<body>  
    ...
    <div class="container">  
        <header>  
            <h1>Members</h1>  
            <div class="controls">  
                <button class="add-attendance">Add Members</button>  
                <select class="all-age">          
        ...
        <main>  
            <section class="attendance-list">  
                <table>  
                    ...
                    <tbody>  
                        <?php  
                        // checking if there are any contacts in the database  
